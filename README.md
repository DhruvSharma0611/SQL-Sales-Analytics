...
2. Open `sql/00_init_database.sql` in SSMS
...
4. Run `00_init_database.sql` — this creates the database, schema, tables and loads all data

5. Run scripts `01` through `13` in order for the full analysis
